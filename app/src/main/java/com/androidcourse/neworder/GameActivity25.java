...
public class GameActivity25 extends AppCompatActivity {
    private final int N = 5;
    Cards cards;
    private ImageView[][] buttons;
    private ImageView bNewGame, bBackMenu, bAbout, ibSound;
    TextView tSScore, tScore, tBestScore, tBestSScore;
    private Intent setButtonSound, setBackgroundMusic, setToastMusic, setWinningSound, setMoveSound;
    ...
    private final int BUTTON_ID[][] = {{R.id.b2500, R.id.b2501, R.id.b2502, R.id.b2503, R.id.b2504},
            {R.id.b2510, R.id.b2511, R.id.b2512, R.id.b2513, R.id.b2514},
            {R.id.b2520, R.id.b2521, R.id.b2522, R.id.b2523, R.id.b2524},
            {R.id.b2530, R.id.b2531, R.id.b2532, R.id.b2533, R.id.b2534},
            {R.id.b2540, R.id.b2541, R.id.b2542, R.id.b2543, R.id.b2544}};
    private final int CADRS_ID[] = {R.drawable.card0, R.drawable.card1, R.drawable.card2, R.drawable.card3, R.drawable.card4, R.drawable.card5,
            ...
            R.drawable.card16, R.drawable.card17, R.drawable.card18, R.drawable.card19, R.drawable.card20,
    ...
    public void newGame() {
        cards.getNewCards();
        numbSteps = 0;
        numbBestSteps = userInDB.getLevel25BestScore();
    ...
    public void checkFinish() {
        if (cards.finished(N, N)) {
            ...
            if ((numbSteps < numbBestSteps) || (numbBestSteps == 0)) {
                userInDB.setLevel25BestScore(numbSteps);
